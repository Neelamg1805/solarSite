...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Choosing a reliable solar EPC company in Kerala for 1 MW+ solar plants is crucial. Local weather, grid regulations, and project performance matter. This article explains what matters in choosing an EPC partner and why Sunvatsa Energy is dependable.',
    author: 'Sunvatsa Energy',
  ...
  },
  {
    ...
    excerpt: 'At Sunvatsa Energy, every building can turn into a power plant. Schools and factories can all create their own clean energy. One of our latest projects proves this idea. We are proud to share the success of a 430 kWp rooftop solar system at Sparsh Global School, Greater Noida (U.P.).',
    author: 'Sunvatsa Energy',
  ...
  {
    id: '4',
    title: 'Solar Company in Odisha - Sunvatsa Energy Leading the Change',
    excerpt: 'Sunvatsa Energy is making significant strides in Odisha, providing cutting-edge solar solutions for businesses and industries. Learn about our commitment to sustainable energy in the region.',
    author: 'Sunvatsa Energy',
